  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 px-4">
      <div className="bg-white rounded-2xl shadow-xl p-6 w-full max-w-md">
        <div className="w-10 h-10 rounded-full bg-brass-100 flex items-center justify-center mb-3">
          <Lock className="w-5 h-5 text-brass-700" strokeWidth={2} />
        </div>
        ...
        <div className="flex flex-wrap gap-2">
          <a
            href="#"
            className="flex-1 text-center bg-ink-900 hover:bg-ink-800 text-white font-semibold px-4 py-3 rounded-xl text-sm cursor-pointer"
          >
            Quero ser Pro
          </a>
          <button
